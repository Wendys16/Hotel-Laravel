    ...
    <div class="p-8 sm:ml-64">
        <div class="p-0">
            <div class="h-10">
                ...
                <hr>
                <br>
                <form class="max-w-md mx-auto" method="post" action="{{ route('hotels.store') }}">
                    @csrf
                    ...
                    <button type="submit"
                        class="text-white bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Guardar</button>
                    <a href="/"
